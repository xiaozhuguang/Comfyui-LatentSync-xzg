...
class FaceDetector:
    def __init__(self, device="cuda"):
        # XZG: buffalo_l 直接放在 models/checkpoints/LatentSync-1.6/models/buffalo_l
        unified = r"E:\ComfyUI-aki-XZG\ComfyUI\models\checkpoints\LatentSync-1.6"

        if os.path.isdir(os.path.join(unified, "models", "buffalo_l")):
            _root = unified
        elif os.path.isdir(r"E:\ComfyUI-aki-XZG\ComfyUI\models\insightface\models\buffalo_l"):
            _root = r"E:\ComfyUI-aki-XZG\ComfyUI\models\insightface"
        else:
            _root = "checkpoints/auxiliary"
